...
config :soon_ready, ash_apis: [
  ...
  SoonReady.UserAuthentication.UserAccount,
  SoonReady.UserAuthentication.Api,
...
config :soon_ready, SoonReadyInterface.Endpoint,
  ...
  live_view: [signing_salt: "rDEyG9A3"]
...
config :soon_ready, SoonReady.Mailer, adapter: Swoosh.Adapters.Local
