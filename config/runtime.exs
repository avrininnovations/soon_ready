...
#
#     PHX_SERVER=true bin/soon_ready start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :soon_ready, SoonReadyInterface.Endpoint, server: true,
    check_origin: [System.get_env("PHX_HOST_FULL_URL")]
end
...
if config_env() == :prod do
  ...
  config :soon_ready, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :soon_ready, SoonReady.Mailer,
