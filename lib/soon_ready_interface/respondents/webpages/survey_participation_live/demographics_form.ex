defmodule SoonReadyInterface.Respondents.Webpages.SurveyParticipationLive.DemographicsForm do
  ...
  def handle_event("submit", %{"form" => form_params}, socket) do
    case AshPhoenix.Form.submit(socket.assigns.form, params: form_params) do
      {:ok, view_model} ->
        send(self(), {:update_params, %{"demographics_form" => normalize(view_model)}})
