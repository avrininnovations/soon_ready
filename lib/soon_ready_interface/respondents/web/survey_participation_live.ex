defmodule SoonReadyInterface.Respondents.Web.SurveyParticipationLive do
  use SoonReadyInterface, :live_view

  import SoonReadyInterface.Respondents.Web.SurveyParticipationLive.Components.Form
  alias SoonReadyInterface.Respondents.Web.SurveyParticipationLive.ViewModels.{
    NicknameForm,
    ScreeningForm
  }
