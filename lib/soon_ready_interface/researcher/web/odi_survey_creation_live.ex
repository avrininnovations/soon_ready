defmodule SoonReadyInterface.Researcher.Web.OdiSurveyCreationLive do
  use SoonReadyInterface, :live_view

  require Logger
  import SoonReadyInterface.Researcher.Web.OdiSurveyCreationLive.Components.Form, only: [
    text_input: 1,
    text_field: 1,
    submit: 1,
    checkbox: 1,
  ]
  alias SoonReadyInterface.Researcher.Web.OdiSurveyCreationLive.ViewModels.{
    BrandNameForm,
