defmodule SoonReadyInterface.Researcher.Webpages.OdiSurveyCreationLive.LiveComponents.LandingPage do
  ...
  alias SoonReadyInterface.Researcher.Webpages.OdiSurveyCreationLive.Forms.LandingPageForm
  ...
  def update(_assigns, socket) do
    socket = assign(socket, :form, AshPhoenix.Form.for_create(LandingPageForm, :create, domain: SoonReadyInterface.Researcher.Domain))
