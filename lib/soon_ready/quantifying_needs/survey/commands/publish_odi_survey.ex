# defmodule SoonReady.QuantifyingNeeds.Survey.Commands.PublishOdiSurvey do
...
#   code_interface do
#     define_for SoonReady.QuantifyingNeeds.Survey.Setup.Api
#     define :new
#     define :dispatch
#   end

#   def execute(command, _state) do
#     SoonReady.QuantifyingNeeds.Survey.DomainEvents.OdiSurveyPublished.new(%{
