defmodule SoonReady.SurveyManagement.V1.DomainConcepts.Question do
  ...
  alias SoonReady.SurveyManagement.V1.DomainConcepts.{MultipleChoiceQuestionGroup, ShortAnswerQuestionGroup}
