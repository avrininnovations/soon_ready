defmodule SoonReady.SurveyManagement.V1.DomainConcepts.MultipleChoiceQuestionGroup do
  use Ash.Resource, data_layer: :embedded, extensions: [SoonReady.Ash.Extensions.JsonEncoder]

  alias SoonReady.SurveyManagement.V1.DomainConcepts.{MultipleChoiceQuestion, MultipleChoiceQuestionGroupPrompt}
